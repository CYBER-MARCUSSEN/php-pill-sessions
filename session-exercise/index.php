...
<main class="form-signin">
    <form action="./login.php" method="POST">
      <img src="./assets/img/14aa-06.jpg" width="40" height="40" class="me-3" alt="imatge">
      <h1 class="h3 mb-3 fw-normal">Si-us-plau inicia sessió</h1>
      ...
      <div class='alert alert-primary' role='alert'><?= ((isset($_GET["logout"]) && $_GET["logout"])) ? "Logout correcte" : "" ?></div>
